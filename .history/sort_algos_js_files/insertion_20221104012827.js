async function insertionSort() {
    ...
    document.getElementById("worst_time").innerText =  //Setting Time complexities
    ...
    document.getElementById("average_time").innerText  //Setting Time complexities
    document.getElementById("worst_time").innerText="O(N^2)";
    document.getElementById("average_time").innerText="Θ(N^2)";
    document.getElementById("best_time").innerText="Ω(N)";
    ...
    //Setting Space complexity
    document.getElementById("space_complexity").innerText="O(1)";
    document.getElementById("best_time").innerText = " //Setting Time complexities
    document.getElementById("worst_time").innerText="O(N^2)";
    document.getElementById("average_time").innerText="Θ(N^2)";
    document.getElementById("best_time").innerText="Ω(N)";
