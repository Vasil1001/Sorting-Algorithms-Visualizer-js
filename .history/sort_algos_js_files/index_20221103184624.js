...
function swap(random_array_100, element1, element2) {
    var temp = random_array_100[element1];
    random_array_100[element1] = random_array_100[element2];
    random_array_100[element2] = temp;
