...
function delayBars(time) {
    return new Promise(r => setTimeout(r, time));
}
let timeSleep = 200; //default sleep time is 200

// Get speed slider
let speedSlider = document.querySelector("#speed_slider");

speedSlider.addEventListener('input', function(){
    console.log(speedSlider.value, typeof(speedSlider.value));
    timeSleep = 320 - parseInt(speedSlider.value);
});
